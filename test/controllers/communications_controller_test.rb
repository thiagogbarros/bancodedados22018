...
class CommunicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create communication" do
    assert_difference('Communication.count') do
      post communications_url, params: { communication: { description: @communication.description } }
    end
  ...
  test "should update communication" do
    patch communication_url(@communication), params: { communication: { description: @communication.description } }
